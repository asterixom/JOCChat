...
//		return true;
	...
	public boolean senden(String sender, final String empfaenger, String Nachricht) {
		...
		String msg = Nachricht.replaceAll("&", "&amp;").replaceAll("\\\\", "&#92;").replaceAll("\"", "&quot;").replaceAll("'", "&#39;").replaceAll("<", "&lt;").replaceAll(">", "&gt;");
		if(db.executeUpdate("insert into Messages set Sender='"+sender+"', Reciever='"+empfaenger+"', Message='"+msg+"'")){
	...
	public ResultSet getGroupMessages(String user){
		return db.executeQuery("select * from Messages,LastUpdate,Access,Users where Users.ID=Access.UserID and Messages.Reciever=Access.GroupID and ");
	}
