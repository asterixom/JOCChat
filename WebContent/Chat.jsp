...
<body style="background-image: url(style/Background.png)">
	...
	<div id="header">
		<div id="banner">
			<img id="logo" SRC="style/JOCChat.png"
				...
				WIDTH="180" HEIGHT="65">
			<div id="logout" align="right"><!-- <a href="Client/Client.jar" target="_blank" download="JOCChat-Client.jar">Download Client</a> -->  Eingeloggt als:</div>
